...
{{-- Hero --}}
<div class="bg-carbon text-cream py-16 px-6">
    <div class="max-w-7xl mx-auto">
        <nav class="text-stone text-xs uppercase tracking-widest mb-4">
        ...
        <h1 class="font-serif text-5xl font-light">{{ $category->name }}</h1>
        @if($category->description)
        <p class="text-stone mt-2 max-w-xl">{{ $category->description }}</p>
        @endif
    </div>
</div>
...
<div class="border-b border-stone/20 bg-cream sticky top-16 z-30">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 flex gap-6 overflow-x-auto scrollbar-hide">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 py-8" x-data="{ filtersOpen: false, cols: 3 }">
        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    {{-- Mobile filters --}}
                    <button @click="filtersOpen = true" class="lg:hidden text-xs uppercase tracking-widest border border-stone/40 px-3 py-1.5">
                        Filtros
                    </button>
                    {{-- Grid cols --}}
    ...
    <div x-show="filtersOpen" class="fixed inset-0 z-50 lg:hidden" @click.away="filtersOpen = false">
        <div class="fixed inset-0 bg-carbon/50" @click="filtersOpen = false"></div>
        <div class="fixed bottom-0 left-0 right-0 bg-cream rounded-t-2xl p-6 max-h-[85vh] overflow-y-auto">
            <div class="flex items-center justify-between mb-6">
            ...
            <p class="text-stone text-sm">Usa el formulario lateral (en pantallas grandes) o los tabs de subcategoría para filtrar.</p>
            <a href="{{ route('category.show', $category->slug) }}" class="btn-primary w-full text-center mt-4">
