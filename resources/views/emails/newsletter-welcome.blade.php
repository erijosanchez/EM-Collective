...
<div style="background: #1A1A18; padding: 32px; text-align: center; margin: 24px 0;">
    ...
    <p style="color: #B85C38; font-size: 12px; margin-top: 8px;">10% de descuento en tu primera compra</p>
</div>
...
<table cellpadding="0" cellspacing="0" style="margin: 16px 0;">
    ...
    <tr>
        <td style="padding: 8px 0; width: 24px; color: #B85C38; vertical-align: top; font-size: 14px; border: none;">{{ $icon }}</td>
